...
"}")
        ...
        self.widget = QtWidgets.QWidget(self.tabTurnos)
        self.widget.setGeometry(QtCore.QRect(10, 10, 256, 356))
        self.widget.setObjectName("widget")
        self.gridLayout_27 = QtWidgets.QGridLayout(self.widget)
        self.gridLayout_27.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_27.setObjectName("gridLayout_27")
        self.tbTurnos = QtWidgets.QToolBox(self.widget)
        self.tbTurnos.setObjectName("tbTurnos")
        self.page = QtWidgets.QWidget()
        self.page.setGeometry(QtCore.QRect(0, 0, 291, 218))
        ...
        self.cbGuardar = QtWidgets.QComboBox(self.widget)
        ...
        self.btnCerrar_Turnos = QtWidgets.QPushButton(self.widget)
        ...
        self.tabEmpleados.setCurrentIndex(2)
